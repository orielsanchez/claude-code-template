...
const { detectJavaScriptProject } = require('./JavaScriptDetector');
const { detectPythonProject } = require('./PythonDetector');
const { detectRustProject } = require('./RustDetector');
const { detectSwiftProject } = require('./SwiftDetector');
...
function detectFrameworks(projectPath) {
  ...
  try {
    ...
    detectSwiftProject(projectPath, result);
