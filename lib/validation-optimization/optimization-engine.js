...
class OptimizationEngine extends BaseManager {
  constructor(options = {}) {
    // Modern BaseManager pattern
    const optimizationOptions = {
      userId: options.userId || 'default-user',
      configManager: options.configManager,
      subDir: options.subDir || 'optimization',
      pluginName: options.pluginName || 'optimization-engine',
      ...options
    };

    super(optimizationOptions);
